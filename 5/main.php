...
try {
    ...
    $sql = "SELECT * FROM books ORDER BY id DESC; /*これが抜けていたせいでSQLSTATE[42000]:Syntax error or access violation: 1065 Query was emptyだった*/ 
    ";
        ...
        <table>
            ...
            <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                <tr class = "contents">
                    ...
                    <td><?php $timestamp = strtotime($row['date']);//timestampの取得はここでいいのか？(マナー的に)
